...
function convertApiPostToUIPost(apiPost: ApiPost): any {
  return {
    ...
    category: apiPost.tags && apiPost.tags.length > 0 
      ? {
          id: apiPost.tags[0].id.toString(),
          name: apiPost.tags[0].name,
          color: "#3b82f6",
        }
      : undefined,
...
export default function FavoritesPage() {
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      ...
      try {
        ...
        setError(err instanceof Error ? err.message : "เกิดข้อผิดพลาดในการโหลดโพสต์ที่ถูกใจ");
  ...
  }, [user, pagination.page, sortBy, sortOrder]);
          ...
          <FadeUp>
            ...
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">กำลังโหลดโพสต์ที่ถูกใจ...</h3>
              </div>
            ) : error ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">ยังไม่มีโพสต์ที่ถูกใจ</h3>
                <p className="text-muted-foreground max-w-sm">
                  คุณยังไม่ได้เพิ่มโพสต์ใดลงในรายการที่ถูกใจ
                </p>
              </div>
            )}
